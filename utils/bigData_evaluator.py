...
from data.bigData import *

class BigDataEvaluator():
    """
    evaluate val dataset using COCO API
    """
    def __init__(self, data_dir, img_size, device, testset=True, transform=None):
        """
        Args:
